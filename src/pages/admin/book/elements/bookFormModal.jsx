    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg w-full max-w-2xl p-6 relative text-black max-h-[90vh] overflow-y-auto">
                ...
                <h2 className="text-xl font-semibold mb-4">{initialData ? 'Edit Book' : 'Add Book'}</h2>
                ...
                <form onSubmit={handleSubmit(handleFormSubmit)}>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="w-full border rounded px-3 py-2"
                        />
                        {errors.book_link && <p className="text-red-500 text-sm">{errors.book_link.message}</p>}
                    </div>
                    ...
                    <div className="mt-6 text-right">
                        <button type="submit" className="bg-yellow-700 text-white px-6 py-2 rounded">
